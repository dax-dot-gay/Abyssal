...
export const shadcnCssVariableResolver: CSSVariablesResolver = () => ({
    variables: {
        ...
        "--mantine-primary-color-light-hover":
            "var(--mantine-color-fuchsia-light-hover)",
        "--mantine-primary-color-light-color":
            "var(--mantine-color-fuchsia-light-color)",
    },
    light: {
        ...
        "--mantine-color-slate-light": alpha(
        ...
        "--mantine-color-stone-light": alpha(
        ...
        "--mantine-color-amber-light": alpha(
        ...
        "--mantine-color-green-light": alpha(
    ...
    dark: {
        ...
        // all light colors
        "--mantine-color-zinc-light": alpha(
            "var(--mantine-color-zinc-4)",
            0.15,
        ),
        "--mantine-color-zinc-light-hover": alpha(
        ...
        "--mantine-color-gray-light": alpha(
            "var(--mantine-color-gray-4)",
            0.15,
        ),
        "--mantine-color-gray-light-hover": alpha(
        ...
        "--mantine-color-rose-light": alpha(
            "var(--mantine-color-rose-4)",
            0.15,
        ),
        "--mantine-color-rose-light-hover": alpha(
        ...
        "--mantine-color-lime-light": alpha(
            "var(--mantine-color-lime-4)",
            0.15,
        ),
        "--mantine-color-lime-light-hover": alpha(
        ...
        "--mantine-color-teal-light": alpha(
            "var(--mantine-color-teal-4)",
            0.15,
        ),
        "--mantine-color-teal-light-hover": alpha(
        ...
        "--mantine-color-cyan-light": alpha(
            "var(--mantine-color-cyan-4)",
            0.15,
        ),
        "--mantine-color-cyan-light-hover": alpha(
        ...
        "--mantine-color-blue-light": alpha(
            "var(--mantine-color-blue-4)",
            0.15,
        ),
        "--mantine-color-blue-light-hover": alpha(
        ...
        "--mantine-color-pink-light": alpha(
            "var(--mantine-color-pink-4)",
            0.15,
        ),
        "--mantine-color-pink-light-hover": alpha(
